...
write_csv(sims_opt_behavior, file = here("data/optimal_behaviors_terms.csv"))
...
ggsave(filename = here("output/opt_beh_plot.png"),opt_beh_plot)
...
ggsave(filename = here("output/prestige_opt_beh_plot.png"),prestige_opt_beh_plot)
